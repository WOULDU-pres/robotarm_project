...
"""autogenerated by genpy from arm_info/kinemaricsRequest.msg. Do not edit."""
import codecs
import sys
...
class kinemaricsRequest(genpy.Message):
  ...
  _type = "arm_info/kinemaricsRequest"
...
def _get_struct_12d():
    ...
    return _struct_12d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from arm_info/kinemaricsResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class kinemaricsResponse(genpy.Message):
  ...
  _type = "arm_info/kinemaricsResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# response
float64 joint1
float64 joint2
