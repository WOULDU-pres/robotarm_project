...
# Load model
model = attempt_load('/home/jetson/catkin_ws/src/arm_garbage_identify/model0.pt', map_location=device)  # load FP32 model
...
#                 print(joints)
    ...
    def garbage_run(self, image):
        ...
        if self.garbage_index<3:
            cv.putText(self.frame, txt0, (190, 100), cv.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 2)
